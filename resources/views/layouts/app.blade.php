...
<head>
    ...
    <title>NaijaLink Network Management - @yield('title')</title>
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link
        href="https://cdn.datatables.net/v/bs5/jq-3.7.0/jszip-3.10.1/dt-2.2.2/b-3.2.2/b-colvis-3.2.2/b-html5-3.2.2/b-print-3.2.2/r-3.0.4/datatables.min.css"
        rel="stylesheet" integrity="sha384-36xVYoVpuj+hzfRrR91sSCo/8Iji7nvnohlqUFSlILIW0+haq7cly9vtVhRt/1J+"
...
<body class="font-sans antialiased text-xs dark:bg-black dark:text-white/50">
        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar py-4 px-0">
                ...
                <ul class="nav flex-column px-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('routers') }}"
                            class="nav-link {{ request()->routeIs('routers') ? 'active' : '' }}">
                            <i class="fas fa-network-wired me-2"></i> Routers
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('plans') }}"
                            class="nav-link {{ request()->routeIs('plans') ? 'active' : '' }}">
                            <i class="fas fa-project-diagram me-2"></i> Plans
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('users') }}"
    ...
    <script
        src="https://cdn.datatables.net/v/bs5/jq-3.7.0/jszip-3.10.1/dt-2.2.2/b-3.2.2/b-colvis-3.2.2/b-html5-3.2.2/b-print-3.2.2/r-3.0.4/datatables.min.js"
        integrity="sha384-qWl+l3Q5bpd1v1LD0Y3N+Y6jhIaFL5gVbG4JelfgXbdRjEuLsQwYrdOYIVeQgS0J" crossorigin="anonymous">
    </script>
